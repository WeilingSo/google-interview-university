...
* 译者：[aleen42](https://github.com/aleen42)，[Newton](https://github.com/Newt0n)，[bobmayuze](https://github.com/bobmayuze)，[Jaeger](https://github.com/laobie)，[sqrthree](https://github.com/sqrthree)，[Johnny Law](https://github.com/longjj)
* Notice: Some terminology will be keep in English.
...
# [译] Coding Interview University

> 我最初为了成为一个软件工程师创建了这个库作为一个短小关于学习主题的待办事项，但是如今如你所见它增长为一个很大的列表。当我完成了这个学习计划，我成功受聘成为Amazon的软件开发工程师！你可能不需要像我那样学习那么多，但是无论如何，你需要的都在这里了。

> 下面列出的学习项目会让你对任何软件公司的面试准备得更加充分，包括一些巨头：Amazon, Facebook, Google 或 Microsoft。
...
这是我为了从 web 开发者（自学、非计算机科学学位）蜕变至大公司软件工程师所制定的计划，其内容历时数月。

![白板上编程 ———— 来自 HBO 频道的剧集，“硅谷”](https://dng5l3qzreal6.cloudfront.net/2016/Aug/coding_board_small-1470866369118.jpg)

这篇文章对于**入门软件工程师**或者那些从软件/web开发转到软件工程开发（需要计算机科学的知识）的人来说是有意义的。如果你有了很多年开发经验并且声称有多年的软件工程实践经验，请期待一个更加困难的面试。

如果你有多年的软件/网页开发的经验，你需要注意那些软件巨头公司如Google，Amazon，Facebook和Microsoft 会把软件工程和软件/网页开发视为两种不同的东西，他们会对软件工程师有计算机科学的知识要求。

如果你想成为一个可靠的工程师或者系统工程师，请进一步学习可选列表里面的知识（网络，安全）。
...
- [数据结构](#数据结构)
- [数组（Arrays）](#数组arrays)
- [连接链表（Linked Lists）](#连接链表linked-lists)
- [栈（Stack）](#栈stack)
- [队列（Queue）](#队列queue)
...
- 平衡查找树（Balanced search trees）（宏观概念，不涉及细节）
- 遍历：先序遍历，中序遍历，后序遍历，BFS，DFS
- [排序](#排序sorting)
  - 选择排序
  - 插入排序
  - 堆排序
...
- [面向对象编程](#面向对象比编程object-oriented-programming)
- [设计模式](#设计模式design-patterns)
...
- [字节序](#字节序)
- [网络](#网络)
- [系统设计, 可扩展性, 数据处理(如果你有4+ 年的工作经验)](#系统设计, 可扩展性, 数据处理)
- [终面](#终面)
- [编码问题实践](#编码问题实践)
- [编码练习和挑战](#编码练习和挑战)
- [当你临近面试时](#当你临近面试时)
...
当我开始这个学习项目的时候，我不知道堆栈，不是到大O分析法，不知道关于树的任何东西，或者是如何遍历一幅图。如果我不得不编码一段排序算法，我可以分辨出来它不算非常好。每一个我曾经用过的数据结构都是在编程语言李敏啊内建好的了，我一点也不知道他们在底层是如何工作的。我从来都不会管理内存除非我正在跑的进程出现了一个"内存溢出"的错误，然后再去找解决方案。在我的编程生涯中我只用了几次多维的数组但是却用了成千上万次关联数组，但是我却从来没有从头开始构建过一个数据结构。

这是一个长期计划。这会花费你数个月的时间。如果你已经熟悉这里面的大部分内容的话这会为你节约掉不少时间。
...
- 成功的软件工程师都是聪明的，但是他们当中很多人都有一种潜意识认为他们不够聪明
- [天才程序员的神话](https://www.youtube.com/watch?v=0SARbwvhupQ)
- [独自前行是危险的：与潜行在科技中的隐形怪物作斗争](https://www.youtube.com/watch?v=1i8ylq4j_EY)
- [相信你自己可以改变](http://www.aaronsw.com/weblog/dweck)
...
在大多数公司的面试当中，你可以在编程这一环节，使用一种自己用起来较为舒适的语言去完成编程。但在 大公司，你只有三种固定的选择：

- C++
- Java
- Python

有时你也可以使用下面两种，但需要事先查阅说明。因为，说明中会有注意事项：
...
由于，我正在学习C、C++ 和Python。因此，在下面你会看到部分关于它们的学习资料。相关书籍请看文章的底部。

## 书单

这里是一个比我用的版本更短的书单。这里使用缩写以节约你的时间。
...
- [ ] [Programming Interviews Exposed: Secrets to Landing Your Next Job, 2nd Edition](http://www.wiley.com/WileyCDA/WileyTitle/productCd-047012167X.html)
    - 用C++和Java写的答案
    - 对于成功应对代码面试是一个很好的热身
    - 不算特别难，大部分问题比你将要在面试里面看到的要简单（参考从我所看来的情况）
...
- [ ] [Write Great Code: Volume 1: Understanding the Machine](https://www.amazon.com/Write-Great-Code-Understanding-Machine/dp/1593270038)
    - 此书在2004年发行，这已经有一点过时了，但是这是一个简要了解计算机工作的了不起的学习资料。
    - 此书作者发明了HLA，所以用了大量的关于HLA的例子，这些东西不太常用但是确实了解汇编语言的好例子。
    - 这些章节是值得一读的:
...
- [ ] [Computer Architecture, Fifth Edition: A Quantitative Approach](https://www.amazon.com/dp/012383872X/)
    - 内容更丰富，更加时新，但是耗时gegn更长。
    - For a richer, more up-to-date (2011), but longer treatment

### 关于特定的编程语言

**你需要为面试选择一个特定的编程语言（参考上面）。**下面是我推荐的编程语言。我没有所有语言的学习资源。我欢迎补充。

如果你通读了其中的一门编程语言，你应该已经了解了所有你需要用在编程问题上的数据结构和算法的知识。**你可以跳过本项目的所有的视频课程**，除非你想要复习一下。

[额外的编程语言学习资源](programming-language-resources.md)

### C++

我没有读过这两本，但是它们很火热，由Sedgewick撰写。他是一个非常出众的人。

- [ ] [Algorithms in C++, Parts 1-4: Fundamentals, Data Structure, Sorting, Searching](https://www.amazon.com/Algorithms-Parts-1-4-Fundamentals-Structure/dp/0201350882/)
- [ ] [Algorithms in C++ Part 5: Graph Algorithms](https://www.amazon.com/Algorithms-Part-Graph-3rd-Pt-5/dp/0201361183/)

如果你有更好的关于C++学习资源的推荐，请告诉我。我们正寻求一个全面的资源。
...
- [ ] [Data Structures and Algorithms in Java](https://www.amazon.com/Data-Structures-Algorithms-Michael-Goodrich/dp/1118771338/)
    - 由 Goodrich, Tamassia, Goldwasser 撰写
    - UC 伯克利大学的CS intro课程的自选课本
    - 参考我的关于python版本的读书报告。这本书覆盖了相同的话题。

### Python

- [ ] [Data Structures and Algorithms in Python](https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275/)
    - 由 Goodrich, Tamassia, Goldwasser 撰写
    - 我爱这本书，此数覆盖了所有的知识点甚至更多。
    - Pythonic 风格的代码
    - 我的还在书写的读书报告: https://startupnextdoor.com/book-report-data-structures-and-algorithms-in-python/


### 可选书本

**一些人推荐下面这些书本，但是我觉得这有点超负荷了。除非你已经有了很多年的软件工程经验并且准备的是一个更加困难的面试**

- [ ] [Algorithm Design Manual](http://www.amazon.com/Algorithm-Design-Manual-Steven-Skiena/dp/1849967202) (Skiena)
    - 可以当作复习或者常见问题查询
    - 算法目录所涉及到的知识已经超过了你将会在面试中你遇到的问题的难度。
    - 本书有两个部分:
        - 数据结构和算法的授课教材
            - 优点:
                - 像所有其他的算法课本一样是一个很好的复习
                - 他在公司和学校解决问题的经验是很好的故事
                - C语言代码样例
            - 缺点:
                - 可以像CLRS一样密集或难以穿透，在某些情况下，CLRS可能是某些科目更好的选择
                - 第7章，第8章，第9章可能会令人痛苦，因为有些项目解释不好，需要我更多的脑力
                - 不要误会我的意思：我喜欢Skiena，他的教学风格和行为举止，但我可能不是很能领会Stony Brook的材料。
        - 算法目录：
            - 这是你买此书的真正理由。
            - 即将到达这部分。 一旦我通过它，我会在这里更新。
    - 可以在kindle上租用它
    - 参考答案:
...
- [ ] [Introduction to Algorithms](https://www.amazon.com/Introduction-Algorithms-3rd-MIT-Press/dp/0262033844)
    - **重要提示：**阅读本书只会有有限的作用。 本书是对算法和数据结构的很好的回顾，但不会教你如何编写好的代码。 你必须能够有效地编写一个好的解决方案。
    - 又名CLR，有时候是CLRS，因为Stein迟到了比赛

- [ ] [Programming Pearls](http://www.amazon.com/Programming-Pearls-2nd-Jon-Bentley/dp/0201657880)
    - 前几章介绍了编程问题的巧妙解决方案（一些使用数据磁带的老旧程序），但这只是一个介绍。 这是一个关于程序设计和体系结构的指南，与Code Complete非常相似，但要短得多。

- ~~"Algorithms and Programming: Problems and Solutions" by Shen~~
    - 一本好书，但是在解决好几页问题后，我对Pascal感到沮丧，do while 循环，一维数组以及不确定的后置条件。
    - 宁愿花时间从另一本书或在线编码问题编码问题。
...
- [我的抽认卡数据库(旧的-1200张卡片)](https://github.com/jwasham/computer-science-flash-cards/blob/master/cards-jwasham.db):
- [我的抽认卡数据库(新的-1800张卡片)](https://github.com/jwasham/computer-science-flash-cards/blob/master/cards-jwasham-extreme.db):

有一点需要记住的是，我做事有点过头，以至于把卡片都覆盖到所有的东西上。从汇编语言和 Python 的细枝末节，乃至到机器学习和统计都被覆盖到卡片上。而这种做法，对于一般面试求来说，却是多余。

**在抽认卡上做笔记：** 若你第一次发现你知道问题的答案时，先不要急着把其标注成“已懂”。你需要做的，是去查看一下是否有同样的抽认卡，并在你真正懂得如何解决问题之前，多问自己几次。重复地问答可帮助您深刻记住该知识点。

另外一种使用我的抽认卡的方法是[Anki](http://ankisrs.net/)，这已经被多次推荐给我。 它使用重复系统来帮助你记住。
它对用户体验友好，可在所有平台上使用，并具有云同步系统。 它在iOS上花费25美元，但在其他平台上免费。

我的Anki格式的抽认卡数据库：https://ankiweb.net/shared/info/25173560 (感谢 [@xiewenya](https://github.com/xiewenya))
...
- Python —— 使用内建的数据类 型（为了持续练习 Python）
- 并编写一些测试去保证自己代码的正确性。有时，只需要使用断言函数 assert() 即可。
- 此外，你也可以使用 Java 或其他语言。以上只是我的个人偏好而已。

你不需要完成所有的内容，你只需要[选择一门用于面试的语言](#关于特定的编程语言)
...
- [ ] **学习C语言**
    - C语言无处不在。 在你的学习期间，你会在书本，讲座，视频，*无处不在*看到例子。
    - [ ] [C Programming Language, Vol 2](https://www.amazon.com/Programming-Language-Brian-W-Kernighan/dp/0131103628)
        - 这是一本简短的书，但它会给你一个很好的C语言处理，如果你练习一点，你会很快熟练掌握。 理解C有助于你理解程序和内存是如何工作的。
        - [问题的解答](https://github.com/lekkas/c-algorithms)
...
- ### 队列（Queue）
    ...
    - [ ] [环状队列/先进先出（FIFO）](https://en.wikipedia.org/wiki/Circular_buffer)
    ...
    - [ ] 使用含有尾部指针的链表来实现:
        ...
        - full()
    - [ ] 开销：
        - 一种使用链表所实现的队列的糟糕实现方法下，其入列和出列的时间复杂度将会是 O(n)。因为，你需要找到下一个元素，以致循环整个队列
...
- ### 按位运算（Bitwise operations）
    - [ ] [Bits 速查表](https://github.com/jwasham/google-interview-university/blob/master/extras/cheat%20sheets/bits-cheat-cheet.pdf) - 你需要知道大量2的幂数值（从2^1 到 2^16 及 2^32）
    - [ ] 好好理解位操作符的含义：&、|、^、~、>>、<<
  ...
  [位操作（视频）](https://www.youtube.com/watch?v=7jkIUgLC29I)
    ...
    - [ ] 反码和补码
        ...
        - [反码（1s Complement）](https://en.wikipedia.org/wiki/Ones%27_complement)
...
- ### 堆（Heap） / 优先级队列（Priority Queue） / 二叉堆（Binary Heap）
    ...
    - [ ] 实现一个最大堆：
        ...
        - [ ] heap_sort() —— 拿到一个未排序的数组，然后使用大顶堆进行就地排序
            - 注意：若用最小堆可节省操作，但导致空间复杂度加倍。（无法做到就地）
